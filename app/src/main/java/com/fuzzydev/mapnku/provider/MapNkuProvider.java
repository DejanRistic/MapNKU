...
public final class MapNkuProvider extends ContentProvider {

    private static final String LOG_TAG = MapNkuProvider.class.getSimpleName();

    /* package */ static final boolean ACTIVATE_ALL_LOGS = false;

    protected static final String DATABASE_NAME = "MapNkuProvider.db";

    public static final String AUTHORITY = "com.fuzzydev.mapnku.provider.MapNkuProvider";
    ...
    private enum UriType {
        DB_LOCATION_ITEM(DbLocationItem.TABLE_NAME, DbLocationItem.TABLE_NAME, DbLocationItem.TYPE_ELEM_TYPE),
        DB_LOCATION_ITEM_ID(DbLocationItem.TABLE_NAME + "/#", DbLocationItem.TABLE_NAME, DbLocationItem.TYPE_DIR_TYPE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            Log.d(LOG_TAG, "Creating MapNkuProvider database");

            // Create all tables here; each class has its own method
            DbLocationItem.createTable(db);
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            DbLocationItem.upgradeTable(db, oldVersion, newVersion);
        }
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        try {
            switch (uriType) {
                case DB_LOCATION_ITEM:
                    insertStmt = db.compileStatement(DbLocationItem.getBulkInsertString());
                    for (ContentValues value : values) {
                        DbLocationItem.bindValuesInBulkInsert(insertStmt, value);
                        insertStmt.execute();
